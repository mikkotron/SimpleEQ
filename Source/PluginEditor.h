...
struct AnalyzerPathGenerator
{
    ...
    void generatePath(const std::vector<float>& renderData, juce::Rectangle<float> fftBounds, int fftSize, float binWidth, float negativeInfinity)
    {
        ...
        const int pathResolution = 2; // you can draw line to every pathResolution pixels
...
private:
    ...
    PowerButton lowcutBypassButton, peakBypassButton, highcutBypassButton; AnalyzerButton analyzerEnabledButton;
